...
const DICT: Dictionary = {
  ...
  "nav.tournament": { it: "Modalità torneo", en: "Tournament mode" },
  ...
  "home.notificationsActive": {
    it: "Notifiche attivate: riceverai un avviso per nuove partite e pagelle.",
    en: "Notifications enabled: you will receive alerts for new matches and ratings.",
  },
  "home.notificationsActivating": { it: "Attivazione...", en: "Activating..." },
  "home.notificationsRetry": {
    it: "Riprova o controlla i permessi.",
    en: "Try again or check permissions.",
  },
  "common.delete": { it: "Elimina", en: "Delete" },
  "common.deleteMatch": { it: "Elimina partita", en: "Delete match" },
  // Crea partita
  ...
  "players.sportPerWeekShort": { it: "/sett", en: "/wk" },
  "players.footballAgo": { it: "anni fa", en: "years ago" },
  "players.sportLabel": { it: "sport", en: "sport" },
  "players.footballLabel": { it: "calcio", en: "football" },
  ...
  "history.connectionError": { it: "Errore di connessione.", en: "Connection error." },
  "history.loading": { it: "Caricamento...", en: "Loading..." },
  ...
  "standings.sortBy": { it: "Ordina per", en: "Sort by" },
  "standings.sortGoals": { it: "Goal", en: "Goals" },
  "standings.sortAvg": { it: "Media gol", en: "Goal avg" },
  "standings.sortScore": { it: "Score", en: "Score" },
  "standings.sortPresenze": { it: "Presenze", en: "Appearances" },
  "standings.sortName": { it: "Nome", en: "Name" },
  // Statistiche
  "stats.title": { it: "Statistiche", en: "Statistics" },
  "stats.period": { it: "Periodo:", en: "Period:" },
  "stats.last10": { it: "Ultime 10 partite", en: "Last 10 matches" },
  "stats.goalsOverTime": { it: "Goal per partita", en: "Goals per match" },
  "stats.avgRatings": { it: "Media voti per giocatore", en: "Avg rating per player" },
  "stats.playerComparison": { it: "Confronto giocatori", en: "Player comparison" },
  "stats.personalHistory": { it: "Storico personale", en: "Personal history" },
  "stats.loading": { it: "Caricamento...", en: "Loading..." },
  "stats.empty": { it: "Nessun dato nel periodo selezionato.", en: "No data in selected period." },
  "stats.error": { it: "Errore caricamento statistiche.", en: "Error loading statistics." },
  "stats.goals": { it: "Goal", en: "Goals" },
  "stats.avgRating": { it: "Media voto", en: "Avg rating" },
  "stats.score": { it: "Score", en: "Score" },
  "stats.presenze": { it: "Presenze", en: "Appearances" },
  "stats.media": { it: "Media", en: "Avg" },
  "stats.noRatings": { it: "—", en: "—" },
  "stats.matchHistory": { it: "Storico partite", en: "Match history" },
  "stats.selectPlayer": { it: "Seleziona un giocatore", en: "Select a player" },
  // Ricerca / UX
  "players.searchPlaceholder": { it: "Cerca giocatore...", en: "Search player..." },
  "theme.dark": { it: "Scuro", en: "Dark" },
  "theme.light": { it: "Chiaro", en: "Light" },
  "theme.label": { it: "Tema", en: "Theme" },
  // Pagelle
  ...
  // Torneo
  "tournament.title": { it: "Modalità torneo", en: "Tournament mode" },
  "tournament.minPlayersError": {
    it: "Devono esserci almeno 15 giocatori per un triangolare di calcio a 5.",
    en: "There must be at least 15 players for a futsal triangular.",
  },
  "tournament.create": { it: "Crea torneo", en: "Create tournament" },
  "tournament.list": { it: "Elenco tornei", en: "Tournament list" },
  "tournament.format": { it: "Formato", en: "Format" },
  "tournament.formatRoundRobin": { it: "Round robin", en: "Round robin" },
  "tournament.formatGroups": { it: "Gironi + playoff", en: "Groups + playoffs" },
  "tournament.numTeams": { it: "Numero squadre", en: "Number of teams" },
  "tournament.noGoalkeepers": { it: "Senza portieri", en: "No goalkeepers" },
  "tournament.suggestTeams": { it: "Suggerisci squadre", en: "Suggest teams" },
  "tournament.manualTeams": { it: "Seleziona manualmente", en: "Manual selection" },
  "tournament.selectPlayers": { it: "Seleziona i giocatori", en: "Select players" },
  "tournament.createTournament": { it: "Crea torneo", en: "Create tournament" },
  "tournament.empty": { it: "Nessun torneo. Creane uno.", en: "No tournaments. Create one." },
  "tournament.bracket": { it: "Tabellone", en: "Bracket" },
  "tournament.standings": { it: "Classifica", en: "Standings" },
  "tournament.topScorers": { it: "Marcatori", en: "Top scorers" },
  "tournament.ratings": { it: "Pagelle", en: "Ratings" },
  "tournament.points": { it: "Pt", en: "Pts" },
  "tournament.goalsFor": { it: "GF", en: "GF" },
  "tournament.goalsAgainst": { it: "GS", en: "GA" },
  "tournament.goalDiff": { it: "DR", en: "GD" },
  "tournament.enterResult": { it: "Inserisci risultato", en: "Enter result" },
  "tournament.saveResult": { it: "Salva", en: "Save" },
  "tournament.scheduled": { it: "Da giocare", en: "Scheduled" },
  "tournament.played": { it: "Giocata", en: "Played" },
  "tournament.team": { it: "Squadra", en: "Team" },
  "tournament.statusDraft": { it: "Bozza", en: "Draft" },
  "tournament.statusOngoing": { it: "In corso", en: "Ongoing" },
  "tournament.statusCompleted": { it: "Completato", en: "Completed" },
  "tournament.name": { it: "Nome torneo", en: "Tournament name" },
  "tournament.date": { it: "Data", en: "Date" },
  "tournament.time": { it: "Ora", en: "Time" },
  "tournament.location": { it: "Luogo", en: "Location" },
  "tournament.deleteConfirm": {
    it: "Eliminare questo torneo? Tabellone, classifica e pagelle verranno cancellati.",
    en: "Delete this tournament? Bracket, standings and ratings will be removed.",
  },
  "tournament.delete": { it: "Elimina torneo", en: "Delete tournament" },
};
